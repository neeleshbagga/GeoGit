...
public class HRPlusTreeUtilsTest {
	...
	public void testPartitionByMinOverlap() {
		...
		HRPlusNode a1 = new HRPlusNode(new ObjectId(), new Envelope(-12, -10,
				-2, 2), new ObjectId());
		HRPlusNode a2 = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, -2,
				2), new ObjectId());
		HRPlusNode a3 = new HRPlusNode(new ObjectId(), new Envelope(-4, -2, -2,
				2), new ObjectId());
		...
		HRPlusNode b1 = new HRPlusNode(new ObjectId(), new Envelope(-12, -10,
				-2, 2), new ObjectId());
		HRPlusNode b2 = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, -2,
				2), new ObjectId());
		HRPlusNode b3 = new HRPlusNode(new ObjectId(), new Envelope(-4, -2, -2,
				2), new ObjectId());
		...
		HRPlusNode c1 = new HRPlusNode(new ObjectId(), new Envelope(-6, -4, 2,
				3), new ObjectId());
		HRPlusNode c2 = new HRPlusNode(new ObjectId(), new Envelope(-3, -2, 4,
				5), new ObjectId());
		HRPlusNode c3 = new HRPlusNode(new ObjectId(),
				new Envelope(-1, 0, 0, 1), new ObjectId());
		HRPlusNode c4 = new HRPlusNode(new ObjectId(), new Envelope(1, 2, -4,
				-3), new ObjectId());
		nodes.add(c1);
		nodes.add(c2);
		nodes.add(c3);
		...
		assertTrue(result.containsAll(HRPlusTreeUtils.partitionByMinOverlap(
				HRPlusTreeUtils.minXSort(nodes),
				HRPlusTreeUtils.maxXSort(nodes))));
		...
		HRPlusNode d1 = new HRPlusNode(new ObjectId(), new Envelope(-10, -8, 3,
				5), new ObjectId());
		HRPlusNode d2 = new HRPlusNode(new ObjectId(), new Envelope(-9, -7, 2,
				4), new ObjectId());
		HRPlusNode d3 = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, 1,
				3), new ObjectId());
		HRPlusNode d4 = new HRPlusNode(new ObjectId(), new Envelope(25, 27, 25,
				27), new ObjectId());
		nodes.add(c1);
		nodes.add(c2);
		nodes.add(c3);
